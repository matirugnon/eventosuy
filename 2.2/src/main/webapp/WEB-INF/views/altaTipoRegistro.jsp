        ...
        <main>
            <section class="panel">
                <div class="panel-body">
                    <h2 style="margin: 0 0 1.5rem 0; color: #182080;">Alta de Tipo de Registro - ${edicion.evento} - ${edicion.nombre}</h2>
                    ...
                    <c:if test="${not empty success}">
                        <div class="success-message">
                            ✅ ${success}
                            <br><br>
                            <a href="${pageContext.request.contextPath}/edicionesOrganizadas" class="btn-link">Volver a Ediciones Organizadas</a>
                        </div>
                    </c:if>
                    ...
                    <c:if test="${not empty edicion}">
                        <div class="edicion-info-header">
                            ...
                            <p>
                                ...
                                <strong>Ubicación:</strong> ${edicion.ciudad}, ${edicion.pais} | 
                    ...
                    <form method="post" action="altaTipoRegistro" id="formAltaTipoRegistro" class="auth-form" novalidate>
                        <input type="hidden" name="edicionNombre" value="${edicion.nombre}">
                        
                        <label class="form-group">
                            <span class="label-text">Edición</span>
                            <input name="edicionNombre" value="${edicion.evento} - ${edicion.nombre}" readonly />
                        </label>
                        ...
                        <label class="form-group">
                            ...
                            <textarea name="descripcion" required rows="3" maxlength="300" 
                                      placeholder="Descripción del tipo de registro…">${param.descripcion}</textarea>
                        </label>
                        ...
                        <div class="grid-2">
                            <label class="form-group">
                                ...
                                <input name="costo" type="number" min="0" step="0.01" required 
                                       placeholder="0.00" value="${param.costo}"/>
                            </label>
                            <label class="form-group">
                                <span class="label-text">Cupo *</span>
                                <input name="cupo" type="number" min="1" step="1" required 
                        ...
                        <div style="margin-top:1rem; display: flex; gap: 1rem; justify-content: center;">
                            <button type="submit" class="btn-primary" style="flex: 1;">Alta Tipo de Registro</button>
