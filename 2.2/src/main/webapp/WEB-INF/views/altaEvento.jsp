			...
			<main>
				<section class="panel">
					<div class="panel-body">
						...
						<form action="${pageContext.request.contextPath}/altaEvento"
							method="post" enctype="multipart/form-data" id="formEvento"
							...
							<div class="form-grid">
								<div class="form-group">
									<label for="nombre">Nombre del evento *</label> <input
										...
										required maxlength="120" placeholder="ej. Concierto de Rock">
								</div>

								<div class="form-group">
									<label for="sigla">Sigla *</label> <input type="text"
										id="sigla" name="sigla" value="${param.sigla}" required
										maxlength="15" placeholder="ej. CR2025">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<textarea id="descripcion" name="descripcion" required
									maxlength="800" placeholder="Breve descripción del evento...">${param.descripcion}</textarea>
							</div>
					...
					<!-- Imagen -->
					<div class="form-group">
						<label for="imagen">Imagen del evento (opcional)</label> <input
