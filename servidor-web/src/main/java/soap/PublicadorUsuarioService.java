 ...
 * 
 */
@WebServiceClient(name = "PublicadorUsuarioService", targetNamespace = "http://publicadores/", wsdlLocation = "http://localhost:9128/publicadorUsuario?wsdl")
public class PublicadorUsuarioService
    extends Service
{

    private static final URL PUBLICADORUSUARIOSERVICE_WSDL_LOCATION;
    private static final WebServiceException PUBLICADORUSUARIOSERVICE_EXCEPTION;
    private static final QName PUBLICADORUSUARIOSERVICE_QNAME = new QName("http://publicadores/", "PublicadorUsuarioService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9128/publicadorUsuario?wsdl");
