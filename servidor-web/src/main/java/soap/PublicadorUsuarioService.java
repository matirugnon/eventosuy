 ...
 * 
 */
@WebServiceClient(name = "PublicadorUsuarioService", targetNamespace = "http://publicadores/", wsdlLocation = "http://localhost:9129/publicadorUsuario?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9129/publicadorUsuario?wsdl");
