				...
				<section class="panel">
					<div class="panel-body">
						...
						<div class="event-detail"
							style="display: flex; gap: 2rem; flex-direction: column;">
							<div style="flex: 1; display: flex; flex-direction: row;">
								...
								<div style="flex: 1; align-items: center; display: flex; flex-direction: column; padding: 0 1rem; gap: 5rem;">
									...
									<c:choose>
										<c:when test="${role == 'asistente'}">
											<c:choose>
												<c:when test="${finalizado}">
													<p style="color: #c00; font-weight: 600;">La edición ya
														finalizó</p>
												</c:when>
												<c:otherwise>
													<a href="${urlBoton}" class="btn-primary" style="width: 100%;"> <c:choose>
										...
										<c:when test="${role == 'organizador' && not empty urlBoton}">
											<a href="${urlBoton}" class="btn-primary">Consultar
												Registros</a>

											<!-- Botón para archivar edición (solo si ya finalizó y el organizador es el dueño) -->
											<c:if
												test="${finalizado && nickname == edicion.organizador && edicion.estado == 'ACEPTADA'}">
												<form
													action="${pageContext.request.contextPath}/archivarEdicion"
								...
								<div
									style="display: flex; flex-direction: column; gap: 2rem; flex: 1; padding: 0 1rem;">
									<c:if test="${not empty eventoPadre}">
										<div>
											<h3 style="color: #182080; margin-bottom: 0.5rem;">Evento</h3>
									...
									<div>
										<h3 style="color: #182080; margin-bottom: 0.5rem;">Organizador</h3>
										<div
											...
											<a
												...
												<div
													style="position: relative; width: 168px; height: 112px;">
													<img
									...
									<c:if test="${not empty edicion.patrocinios}">
										<div>
											<h3 style="color: #182080; margin-bottom: 0.5rem;">Patrocinios</h3>
											<div class="panel"
												style="border: 1px solid #e0e0e0; border-radius: 8px; padding: 0;">
												<ul class="menu-list" style="padding: 0.5rem 0;">
													<c:forEach items="${edicion.patrocinios}" var="patrocinio">
														<li style="padding: 0 0.5rem; margin: 0;"><c:url
